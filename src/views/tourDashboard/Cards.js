            ...
            <CCol xs={12} md={12} xl={12}>
              <CCardBody>
                <div className="creditcart">
                  ...
                  <CFormInput type="text" className="creditcart-input" style={{ direction: 'rtl' }} placeholder="شماره کارت را وارد کنید" />
                </div>

                <div className="shaba-number">
                  <img width="50px" src={require("../../assets/images/bank-iran/no-img.png")} />
                  <span>شماره شبا</span>
                  <CFormInput type="text" className="shaba-input" style={{ direction: 'rtl' }} placeholder=" کد شبا را وارد کنید (بدون IR) " />
                </div>
                <br />
                <CButton>ثبت</CButton>
              </CCardBody>
